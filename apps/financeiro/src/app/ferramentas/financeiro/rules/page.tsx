          ...
          <div className="space-y-4">
            {isLoading ? (
              ...
              <div className="rounded-xl border border-dashed border-border bg-muted/30 px-4 py-6 text-sm text-muted-foreground">
                ...
                <p className="mt-1">
                  Regras mostram como um custo (ex.: supermercado) se distribui entre PJ e PF, ou um valor fixo mensal
                  entre fontes — ideal para fechar a demo com “previsibilidade”.
                </p>
              </div>
            ) : (
              rules.map((rule) => (
          ...
          <div className="space-y-3">
            {isLoading ? (
              ...
              <p className="text-sm text-muted-foreground">
                Quando houver despesas nas categorias referenciadas e fontes vinculadas, o rateio aparece aqui com valores
                em reais — ótimo para mostrar o “antes e depois” na conversa.
              </p>
            ) : (
