/**
 * Design primitives para ferramentas financeiras.
 * Adaptado ao design system do DevFlow.
 */

export const focusRingLight =
  "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background";

export const cardStaticLight =
  "rounded-2xl border border-border bg-card shadow-sm";

export const cardBaseLight =
  "rounded-2xl border border-border bg-card shadow-sm transition hover:-translate-y-px hover:shadow-md";
...
export const h1 = "font-semibold leading-tight tracking-tight";
export const mutedTextLight = "text-muted-foreground";
export const bodyTextSm = "text-[15px] leading-relaxed";
