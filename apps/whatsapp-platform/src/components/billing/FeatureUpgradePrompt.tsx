...
export function FeatureUpgradePrompt({
  ...
  if (isWhiteLabelMode()) {
    return (
      <div role="status" className={shell} data-testid="feature-upgrade-prompt">
        ...
        <div className="flex shrink-0 flex-wrap items-center gap-2">
          {onDismiss ? (
            <Button
              ...
              type="button"
              onClick={onDismiss}
              className="rounded-lg px-2 py-1.5 text-xs font-medium df-text-warning hover:bg-[rgb(245_158_11/0.12)]"
            >
              Fechar
            </Button>
          ) : null}
