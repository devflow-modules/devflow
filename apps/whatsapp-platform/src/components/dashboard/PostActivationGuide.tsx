  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-2xl border border-[var(--df-brand-200)]/80 bg-[var(--df-brand-50)]/40 px-5 py-5">
        ...
        {statusLine ? (
          <p className="mt-2 text-sm font-medium text-slate-700" data-testid="line-status-dashboard">
            {statusLine}
          </p>
        ) : null}
        ...
        {showNumber ? (
          <div className="mt-5 rounded-xl border border-slate-200/80 bg-white px-4 py-4 shadow-sm">
            ...
            <p className="mt-1 break-all font-mono text-lg font-semibold text-slate-900">{formattedLine}</p>
