...
export function MessageList({
  ...
  return (
    <div
      ref={messageListRef}
      className={`flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden bg-gradient-to-b from-muted/40/90 via-card/40 to-slate-100/60 py-5 sm:py-6 ${INBOX_CHAT_GUTTER_X}`}
