  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm rounded-lg border p-6 shadow-sm">
        ...
        <p className="mt-1 text-sm text-gray-600">Entre com seu e-mail e senha</p>
        <form onSubmit={handleSubmit} className="mt-4 space-y-3">
          ...
          <button type="submit" disabled={loading} className="w-full rounded bg-blue-600 px-3 py-2 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-50">
