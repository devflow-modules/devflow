...
**Relacionados:** [CUTOVER-FINANCEIRO-RUNBOOK-MAIN.md](./CUTOVER-FINANCEIRO-RUNBOOK-MAIN.md) (estrutura de blocos), [WHATSAPP_PORTAL_APP_PARITY.md](./WHATSAPP_PORTAL_APP_PARITY.md), [PLANO_TRANSICAO_APP_SUBDOMINIO.md](../../apps/whatsapp-platform/docs/PLANO_TRANSICAO_APP_SUBDOMINIO.md), [DEPLOY_APP_SUBDOMAIN.md](../../apps/whatsapp-platform/docs/DEPLOY_APP_SUBDOMAIN.md).
