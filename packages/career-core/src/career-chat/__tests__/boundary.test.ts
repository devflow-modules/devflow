...
const CAREER_CHAT_ROOT = join(process.cwd(), "src/career-chat");
...
describe("career-chat dependency boundary", () => {
  const sourceFiles = collectSourceFiles(CAREER_CHAT_ROOT);

  for (const filePath of sourceFiles) {
    it(`${filePath.replace(`${CAREER_CHAT_ROOT}/`, "")} avoids forbidden runtime dependencies`, () => {
