...
- Skills: [`product-grill`](../skills/product-grill/SKILL.md), [`revenue-centric-design`](../skills/revenue-centric-design/SKILL.md), [`devflow-product-evidence`](../skills/devflow-product-evidence/SKILL.md); ativação de cliente real WhatsApp: [`whatsapp-client-onboarding`](../skills/whatsapp-client-onboarding/SKILL.md)
