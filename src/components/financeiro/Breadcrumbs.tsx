...
function buildCrumbs(pathname: string): Crumb[] {
  ...
  // Extrai segmentos relativos ao BASE (ex: /ferramentas/financeiro/dashboard -> dashboard)
  ...
  // Para rotas protegidas, preferimos "Dashboard" como raiz.
  if (crumbs[0]?.href !== `${BASE}/dashboard`) {
    crumbs.unshift({ href: `${BASE}/dashboard`, label: "Dashboard" });
  }

  // Evita duplicar "Dashboard" quando a rota atual já é /dashboard
