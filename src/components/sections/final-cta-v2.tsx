  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <div
          className={cn(
            "mx-auto max-w-2xl rounded-2xl border border-border bg-card p-8 text-center shadow-sm sm:p-12",
        ...
        >
          ...
          >
            Comece agora com as ferramentas DevFlow
          </h2>
          <p className="mt-4 text-slate-600">
            Ferramentas prontas, produtos em funcionamento, automação disponível.
