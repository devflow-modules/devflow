      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <p className="text-sm font-medium text-amber-950">
            Roteiro sugerido para apresentação (~5 min) — dados ricos após o seed no ambiente de demo.
          </p>
        </div>
        ...
        <details className="text-xs text-amber-900/90">
          ...
          <p className="mt-2 max-w-3xl leading-relaxed">
            No app Financeiro (<code className="rounded bg-amber-100/80 px-1">apps/financeiro</code>), com o e-mail do
            usuário demo:{" "}
            ...
            Use <code className="rounded bg-amber-100/80 px-1">--reset-demo</code> para limpar só artefatos marcados
            como demo. Logs estruturados: <code className="rounded bg-amber-100/80 px-1">[financeiro-demo]</code>.
          </p>
        </details>
      </div>
    </div>
